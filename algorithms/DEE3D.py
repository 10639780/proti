...
def run(proti):
            ...
            for j in range(len(directions) * parent_counter):
                ...
                for d in directions:
                    ...
                    if i == length - 1 or possible_score == 0:
                        ...
                        pos_x, pos_y, pos_z = nodes_to_xyz(nodes_visited)
                        ...
                        current_score = score_xyz(pos_x, pos_y, pos_z, proti)
    ...
    return runtime, best_score, [best_x, best_y, best_y]
