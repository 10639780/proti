...
De bedoeling is om in deze simulated annealing uit te proberen
"""
import numpy as np 
...
"""
Herhaal dit een aantal keren en pas simulated annealing toe
"""
...
print(np.matrix(grid)) # grid in terminal
