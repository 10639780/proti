"""
Semi random configuration with score rewritten and tested
Seems to work
Now to create an optimization
"""
...
def protein_positions():
    ...
    for amino in range(LENGTH):
        ...
        new_x, new_y, score = score_valid_folds(x, y, grid, element)
...
def plot_protein_config(x_list, y_list, total_score):
    ...
    plt.title("Total score: {}".format(total_score))
    plt.legend()
    plt.show()

        
if __name__ == "__main__":
    grid, x, y, score = protein_positions()
